...
function branch(loadedComponent) {
    ...
    var createBranchComponent = function(posX, posY, title, doCreateExits){
        ...
        myData = { xpos:posX, ypos:posY, type:"branch", content: "", title: title, context: $("#saveContext").val(), events: sevts, showSub: "false", elementId: elementId, reloadContext:reloadContext};
