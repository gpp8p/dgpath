...
// update the pass-fail threshold on an existing branch
var edit_branch = "server_mysqli/editBranch.php";

// copies componentes from the library into a studio context
var copy_context_from = "server_mysqli/cloneContextFrom.php";

// loads component from context id
var load_context_component = "server_mysqli/loadContextComponent.php";

// records a user event
var log_user_event = "server_mysqli/userEventsLog.php";

// creates a new user
var create_new_user = "server_mysqli/createNewUser.php";

// gets a user activity list
var get_user_activity = "server_mysqli/getUserActivity.php";
// gets a single user event
var get_user_event = "server_mysqli/getUserEvent.php";

//gets components and events for a context overlaid with the user events
var get_combined_user_events = "server_mysqli/getCombinedUserEvents.php";
