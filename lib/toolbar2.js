...
var cloneThis = function(pn, cloneObj, direction){
    ...
    var getConfirmCopy = function(popName, copySource, copyTarget, insertLocationX, insertLocationY, event){
        ...
        var myData = {copyTarget:thisCopyTarget, copySource:thisCopySource, componentX:locX, componentY:locY};
        this transaction = urlBase+copy_context_from+"?"+debug;
        e.stopPropagation();
        $.ajax({
            type: "POST",
            url: thisTransaction,
            ...
            if(cloneDirection==0) {
                ...
                if(thisFolderIds[3]=="subcontext"){
                    ...
                    $("#" + selectId).on('click', function (event) {
                        ...
                        getConfirmCopy(popName, thisCopySource, $("#componentX").val(), $("#componentY").val(), event);
                    });
                }
            }
        });
