...
var cloneThis = function(pn, cloneObj){
    ...
    var getConfirmClone = function(popName, objectTitle, ObjectId, ObjectType, selectedTitle, event){
        ...
        $("#cloneYes").on('click', function(){
            ...
            var myData = {subcontext:subContextId};
            $.ajax({
                type: "POST",
                url: thisTransaction,
                data: myData,
...
//                        subElements = subElements + getComponentLineHTML(elementId, contextId, thisContextComponent.title, liclass, "");
        ...
        $.each(seIds, function(key, value){
            ...
            $("#"+selectId).on('click', function(event){
                ...
                getConfirmClone(popName, objectTitle, objectId, objectType, thisFolderIds[2], event);
            });
        });
    };
