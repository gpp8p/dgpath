...
var getConfirmConnection = function(popName, layer){
    ...
    $("#connectGoAhead").on('click', function(){
        newDefaultConnection(popName, layer);
    })
...
var newConnection = function(popName, layer){
    ...
    var thisTransaction = urlBase+insert_default_connection+"?"+debug;
...
var newDefaultConnection = function(popName, layer){
    $("#"+popName).hide();
