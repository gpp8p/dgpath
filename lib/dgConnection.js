        ...
        case 2:
            ...
            $.ajax({
                ...
                success: function(msg) {
                    ...
                    getConfirmConnection("popup3", layer, thisId);
                },
                error: function(err) {
                    alert(err.toString());
                    if (err.status == 200) {
...
var getConfirmConnection = function(popName, layer, thisId){
    var popName = popName;
    ...
    $("#connectConfigure").on('click',function(){
        newConnection(popName, layer, thisId);
    });
...
var newConnection = function(popName, layer, thisId){
    $("#"+popName).hide();
