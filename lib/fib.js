...
function fib(loadedComponent){
 ...
 //       parsedContent = jQuery.parseJSON(res);
    ...
    this.createComponent = function(layerName){
        ...
        processedFib = getComponentEvents(qu);
        elementId = generateUUID();
        insertComponent($("#componentX").val(), $("#componentY").val(), "fib", $("#componentTitle").val(), processedFib[0], $("#saveContext").val(), processedFib[1],"false", elementId, $("#reLoadContext").val());
    ...
    var updateFib = function(t,l){
        ...
        if(ckInstance.checkDirty()){
            ...
            newFibElements = getComponentEvents(newFibContent);
