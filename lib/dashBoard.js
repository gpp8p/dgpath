...
var dashBoard = function(){
    ...
    var showRecentStudentActivity = function(){
        var getActivityScrollSkeleton = function(){
            ...
            strVar += "    <thead>";
            strVar += "    <tr>";
            strVar += "        <th id=\"activityTypeLabel\" width=\"15%\"><\/th>";
            strVar += "        <th id=\"activityTimeLabel\" width=\"15%\"><\/th>";
            strVar += "        <th id=\"activityUserLabel\" width=\"20%\"><\/th>";
            strVar += "        <th id=\"activityDetailLabel\" width=\"50%\"><\/th>";
            strVar += "    <\/tr>";
            strVar += "    <\/thead>";
            strVar += "    <tbody>";
            strVar += "";
