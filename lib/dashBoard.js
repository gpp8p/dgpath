...
//        getMapForContextNow();
    ...
    var getMapForContext = function(contextId) {
        ...
        $.ajax({
            ...
            success: function(msg) {
                ...
                $.each( activityResult, function( key, value ) {
                    ...
                    $("#"+thisRowName+"a").on('hover', function(event){
                        if(event.type=="mouseenter"){
                            $("#"+thisRowName+"a").css('background-color', '#0323f9');
                            $("#"+thisRowName+"a").css('color', '#fffa08');
                            $("#"+thisRowName+"b").css('background-color', '#0323f9');
                            $("#"+thisRowName+"b").css('color', '#fffa08');
                            $("#"+thisRowName+"c").css('background-color', '#0323f9');
                            $("#"+thisRowName+"c").css('color', '#fffa08');
                            $("#"+thisRowName+"d").css('background-color', '#0323f9');
                            $("#"+thisRowName+"d").css('color', '#fffa08');

                        }else{
                            $("#"+thisRowName+"a").css('background-color', '#0de9f9');
                            $("#"+thisRowName+"a").css('color', '#931109');
                            $("#"+thisRowName+"b").css('background-color', '#0de9f9');
                            $("#"+thisRowName+"b").css('color', '#931109');
                            $("#"+thisRowName+"c").css('background-color', '#0de9f9');
                            $("#"+thisRowName+"c").css('color', '#931109');
                            $("#"+thisRowName+"d").css('background-color', '#0de9f9');
                            $("#"+thisRowName+"d").css('color', '#931109');
                        }
                    })
            ...
            var showUserMap = function(userEventId){
                ...
                $.ajax({
                    ...
                    success: function(msg) {
                        ...
                        getMapForContext(thisEventContext);
                    },
                    error: function(err) {
                        alert(err.toString());
                        if (err.status == 200) {
