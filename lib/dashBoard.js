...
var dashBoard = function(){
    ...
    var addNewUser = function(thisTop, thisLeft) {
        ...
        var getUserEntryPanelHtml = function () {
            ...
            strVar += "                <input id = \"emailInput\" type=\"text\" size=\"40\" maxlength = \"80\" required=\"true\" \/>";
            strVar += "            <\/span>";
            strVar += "        <\/td>";
            strVar += "    <\/tr>";
        ...
        var saveNewUser = function(){
            ...
            var myData = {firstname: $("#firstNameInput").val(), lastname: $("#lastNameInput").val(), eid: $("#eidInput").val(), email:$("#emailInput").val(), password:$("#passwordInput").val(), userType: $("#userTypeSelect").val() };
