...
var dashBoard = function(){
    ...
    this.showDashBoardSkeleton = function(){
        ...
        $("#participButton").on('click', function(){
            ...
            $("#statButton").css('background-color','#030bda');
        ...
        $("#notificationButton").on('click', function(){
            $("#dashMenu").html("");
            $("#dashMenu").hide();
            $("#participButton").css('background-color','#030bda');
            $("#notificationButton").css('background-color','#BC7065');
            $("#statButton").css('background-color','#030bda');
        ...
        $("#statButton").on('click', function(){
            $("#dashMenu").html("");
            $("#dashMenu").hide();
            $("#statButton").css('background-color','#BC7065');
            $("#participButton").css('background-color','#030bda');
            $("#notificationButton").css('background-color','#030bda');
    ...
    var getParticipantMenuHtml = function(){
        ...
        strVar += "	<tr>";
        strVar += "		<td class=\"buttonMenuCss\" id = \"menuAddParticipant\">Add Participant<\/td>";
        strVar += "	<\/tr>";
        strVar += "	<tr>";
        strVar += "		<td class=\"buttonMenuCss\" id = \"menuAddLti\">Add LTI Access<\/td>";
        strVar += "	<\/tr>";
        strVar += "	<tr>";
        strVar += "		<td class=\"buttonMenuCss\" id = \"menuMostRecent\">Most Recent Active<\/td>";
        strVar += "	<\/tr>";
        strVar += "	<tr>";
